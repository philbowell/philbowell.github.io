...
<section class="cv-section" aria-labelledby="professional-history">
  ...
  <div class="cv-timeline">
    <article class="cv-role">
      <div class="cv-role-content">
        ...
        <ul>
          <li>Craft elegant experiences that fit real user needs</li>
          <li>Work alongside UX researchers to validate and iterate</li>
          <li>Develop the future vision for adviser products</li>
          <li>Evolve the reimagined UCAS application system</li>
        </ul>
      </div>
    </article>
    ...
    <article class="cv-role">
      <div class="cv-role-content">
        ...
        <ul>
          <li>Developed visual designs to enhance user experience</li>
          <li>Validated designs through user testing</li>
          <li>Contributed to the UCAS Design System</li>
        </ul>
      </div>
    </article>
      ...
      <div class="cv-role-content">
        ...
        <div class="cv-role-children">
          <article class="cv-subrole">
            ...
            <ul>
              <li>Concept work on new websites</li>
              <li>Developed visual consistency for key client websites</li>
              <li>Helped establish a new visual direction for the company website</li>
            </ul>
          </article>
          ...
          <article class="cv-subrole">
            ...
            <ul>
              <li>Guided the strategy of the website</li>
              <li>Continued evolution of functionality and design</li>
              <li>Front-end development across devices</li>
            </ul>
          </article>

          <article class="cv-subrole">
            <p class="cv-date">2016</p>
            <h4>Church's Ministry Among Jewish People</h4>
            <p>New website design and build.</p>
          </article>

          <article class="cv-subrole">
            <p class="cv-date">2014–2015</p>
            <h4>Redcliffe College</h4>
            <p>New brand identity.</p>
          </article>

          <article class="cv-subrole">
            <p class="cv-date">2013</p>
            <h4>Cambray Baptist Church</h4>
            <p>New website, shortlisted for best Small Church Website at the Premier Digital Awards.</p>
          </article>
        </div>
      </div>
    </article>
