# CLAUDE.md — philbowell.github.io
...
Before building, write a plan to `.claude/plans/<issue-slug>.md` and link it from the issue as a comment.
...
3. Write a plan to `.claude/plans/<issue-slug>.md`
